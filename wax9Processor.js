...
class Wax9Processor {
    ...
    update(sn, ax, ay, az, gx, gy, gz, mx, my, mz) {
        let acc = new Vector(ax, ay, az);
        let gyro = new Vector(gx, gy, gz);
        let mag = new Vector(mx, my, mz);
        ...
        return new Wax9(sn, new Date(), acc, gyro, mag, euler, grav, linAcc);
    }
